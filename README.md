...
-k name=infra path=./src/gitops/environments/${env}/infra prune=true sync_interval=30s  \
-k name=apps path=./src/gitops/environments/${env}/apps prune=true sync_interval=30s dependsOn=infra
```